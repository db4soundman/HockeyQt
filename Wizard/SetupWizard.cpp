...
SetupWizard::SetupWizard(QString* pAwayName, QString* pHomeName, QString* pAwayFile,
                         ...
                         int* ppg, int* ppopp, QString* goalies, QString* statcrewName, bool *usingTricaster, QString* awayLogo) :
    wizpage(pAwayName, pHomeName, pAwayFile, pHomeFile, pSponsor, pAnnouncer,
            pAwayRank, pHomeRank, pAwayColor, pHomeColor, pBg, statcrewName, usingTricaster, awayLogo),
