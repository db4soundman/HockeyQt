...
void StandingsGraphic::paint(QPainter* painter, const QStyleOptionGraphicsItem* option,
    ...
    if (show) {
        ...
        painter->fillRect(150, 100, 1520 + 300 - 350, 1200, QColor(20,20,20, 200));
        painter->drawText(1100, 110, 140, 100, Qt::AlignRight | Qt::AlignVCenter, "W-L-T");
        painter->drawText(1420, 110, 140, 100, Qt::AlignRight | Qt::AlignVCenter, "PTS");
        ...
        for (int i = 0; i < nchcStandings.size(); i++) {
            ...
            painter->drawText(1100, 200 + (100*i), 140, 50, Qt::AlignRight | Qt::AlignVCenter,
            ...
            painter->drawText(1420, 200 + (100*i), 140, 50, Qt::AlignRight | Qt::AlignVCenter, QString::number(nchcStandings.at(i).getPoints()));
        }
    }
}
